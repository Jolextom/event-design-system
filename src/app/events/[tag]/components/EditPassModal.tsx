...
export function EditPassModal({ isOpen, onClose, pass, onPassUpdated }: EditPassModalProps) {
    const [type, setType] = useState<PassType>(pass.type);
    const [title, setTitle] = useState(pass.title);
                    ...
                    >
                        <div className="bg-white rounded-[32px] shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto pointer-events-auto">
                            ...
                            <div className="flex items-center justify-between p-8 pb-6 border-b border-gray-100">
                                <div>
                                    <h2 className="text-xl font-black text-gray-900 tracking-tight">Edit Ticket</h2>
                                    <p className="text-xs text-gray-400 font-bold mt-1">Update ticket details</p>
                                </div>
                                <button
                                    onClick={handleClose}
                            ...
                            <div className="p-8 space-y-8">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-bold text-gray-900 focus:outline-none focus:ring-2 focus:ring-[var(--brand-blue)]/20 focus:border-[var(--brand-blue)] transition-all"
                                    />
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea
                                        ...
                                        rows={2}
                                        className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-bold text-gray-900 focus:outline-none focus:ring-2 focus:ring-[var(--brand-blue)]/20 focus:border-[var(--brand-blue)] transition-all resize-none"
                                    />
                                </div>
